...
response = client.provision_product(ProductId="prod-fhg67bjrz2lfq",ProvisionedProductName='dev12', ProvisioningArtifactId='pa-yaowjwwqwb2ks',PathId='lpv2-cah4ladmkq5oc', ProvisioningParameters=a)
print(response)
