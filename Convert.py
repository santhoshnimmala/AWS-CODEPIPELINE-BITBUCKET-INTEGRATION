...
response = client.provision_product(ProductId="prod-fhg67bjrz2lfq",ProvisionedProductName='dev12', ProvisioningArtifactId='pa-yaowjwwqwb2ks',ProvisioningParameters=a)
print(response)
